...
REDDIT = os.environ.get(
    "REDDIT",
    "http://ec2-3-131-244-37.us-east-2.compute.amazonaws.com:9999/forums/all",
)
SHOPPING = os.environ.get(
    "SHOPPING", "http://ec2-3-131-244-37.us-east-2.compute.amazonaws.com:7770/"
)
SHOPPING_ADMIN = os.environ.get(
    "SHOPPING_ADMIN",
    "http://ec2-3-131-244-37.us-east-2.compute.amazonaws.com:7780/admin",
)
GITLAB = os.environ.get(
    "GITLAB",
...
HOMEPAGE = os.environ.get(
    "HOMEPAGE", "http://metis.lti.cs.cmu.edu:4399/scratchpad.html"
)
